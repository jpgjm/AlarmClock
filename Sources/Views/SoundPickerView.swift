            ...
            List {
                ...
                Section {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("ファイル追加: WAV, AIFF, CAF (推奨) / MP3, M4A, AAC / FLAC")
                        Text("FLAC もそのまま使えます (実機で動作確認済み)。")
    ...
    private func handleImport(result: Result<[URL], Error>) {
        ...
        case .success(let urls):
            ...
            if let entry = library.importSound(from: sourceURL) {
                ...
                importErrorMessage = "このファイルを取り込めませんでした。対応形式は WAV / AIFF / CAF / MP3 / M4A / AAC / FLAC です。"
            }
